...
<div class="container">
    ...
    <fieldset id="bulk_upload_student">
        <legend class="Centre_Legends">Bulk Upload Students</legend>
        <button>
        ...
        <form action="process_csv.php" method="post" enctype="multipart/form-data">
            ...
            <input id="file" accept=".csv" type="file" name="file" required><br>
            <input type="submit" name="submit" value="Upload">
        </form>
    </fieldset>

    <fieldset id="Create_one_student">
        <legend class="Centre_Legends">Create One Student</legend>
        <form action="upload_single.php" method="post">
            <input type="text" name="first_name" id="" placeholder="Enter First Name" required><br>
    ...
    <fieldset id="Export_Students">
        <legend class="Centre_Legends">Export Students</legend>
    ...
    <fieldset id="Export_Brands">
        <legend class="Centre_Legends">Export Brands</legend>
    ...
    <fieldset id="Export_Medications">
        <legend class="Centre_Legends">Export Medications</legend>
